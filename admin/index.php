...
<head>
  ...
  <title>Entrepreneur Club | Dashboard</title>
  ...
  ?>
   <tr>
                    ...
                    <td>
                      <div class="d-flex">
                        <div>
                          <img src="../assets/images/profile/<?=$user['profilepic']?>" class="rounded-circle border border-2 shadow-sm mx-2" width="55px" height="55px" />
                        </div>
                        <div>
                          <h5><?=$user['firstname'].' '.$user['lastname']?> - <span class="text-muted">@<?=$user['username']?></span></h5>
                    ...
                    <?php if($user['account_status']==0): ?><button class="m-1 btn btn-warning btn-sm verify_user_btn" data-user-id="<?=$user['id']?>">Verify</button><?php endif; ?>
                     
                      
                        <button style="display:<?=$user['account_status']==1?'':'none'?>" class="m-1 btn btn-danger btn-sm block_user_btn ub" data-user-id="<?=$user['id']?>">Block</button>
                        <button style="display:<?=$user['account_status']==2?'':'none'?>" class="m-1 btn btn-primary btn-sm unblock_user_btn" data-user-id="<?=$user['id']?>">Unblock</button>
...
?>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2023 <a href="" target="_blank">NEXUS Pvt Ltd.</a>.</strong>
    All rights reserved.
